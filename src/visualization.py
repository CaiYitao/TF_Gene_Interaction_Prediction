...
def plot_subgraph_with_labels(predicted_edge_labels, batch, gene_names, num_nodes=20, anchor_gene_name=None, save_path=None):
    ...
    # Draw the subgraph with node labels and edge colors
    nx.draw(subgraph, pos, with_labels=True, labels=subgraph_gene_names, node_size=300, node_color='lightblue',
...
def plot_provided_subgraph_with_labels(predicted_edge_labels, batch, gene_names, node_list, save_path=None):
    ...
    # Plot the subgraph with labels, node sizes, and colored edges
    nx.draw(G, pos, with_labels=True, labels=subgraph_gene_names, node_size=500, node_color='lightblue', 
...
def main():
    ...
    dataset = load_data('TF_Gene_Interaction_Prediction/data/expression_matrix.csv', 'TF_Gene_Interaction_Prediction/data/suberites_presence_absence.csv')
    #load model
   ...
   # plot the subgraph with predicted edge labels
    ...
    plot_provided_subgraph_with_labels(pel,data,gene_names, node_list, save_path='/Users/caiyitao/Documents/观澜阁/TF_Gene_Interaction_Prediction/plot/provided_subgraph_with__labels.png')
